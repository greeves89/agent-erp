...
const erpNav = [
  ...
  { href: "/erp/customers", label: "Customers", icon: Users, exact: false },
  { href: "/erp/orders", label: "Orders", icon: ShoppingCart, exact: false },
  { href: "/erp/invoices", label: "Invoices", icon: FileText, exact: false },
];
